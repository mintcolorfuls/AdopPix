    ...
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HourType", x => x.HourId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auctions_HourType_HourId",
                        column: x => x.HourId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RedirectToUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AvaterName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    coverName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuctionImages_ImageTypes_ImageTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AucNotiId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AuctionId = table.Column<string>(type: "varchar(255)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionNotifications", x => x.AucNotiId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionImages_ImageTypeId",
                table: "AuctionImages",
                column: "ImageTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionNotifications_UserId",
                table: "AuctionNotifications",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Auctions_HourId",
                table: "Auctions",
                column: "HourId");
